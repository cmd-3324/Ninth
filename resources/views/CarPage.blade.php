            ...
            document.querySelectorAll(".btn-view-replies").forEach(btn => {
                btn.addEventListener("click", function() {
                    ...
                    if (container.classList.contains("hidden")) {
                        ...
                        this.textContent = this.textContent.replace(/^View replies/, "Hide replies");
                    } else {
                        container.classList.add("hidden");
                        this.textContent = this.textContent.replace(/^Hide replies/, "View replies");
                    }
                });
            });

            document.querySelectorAll(".btn-toggle-reply-form").forEach(btn => {
                btn.addEventListener("click", function() {
                    const targetId = this.dataset.target;
